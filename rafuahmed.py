...
\033[1;37m    ######      ######     ########  
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Fuyad Rafu 
\033[1;37m Facebook:           Fuyad Ghuma'cche
\033[1;37m Github  :            fuyadghumacche
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open Message FUYAD AHMED on WhatsApp. https://wa.me/8801735059658')
        pass
    elif select =='F':
        os.system('xdg-open https://www.facebook.com/Fuyad.yoUr.nxT.crUsh.0/')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
